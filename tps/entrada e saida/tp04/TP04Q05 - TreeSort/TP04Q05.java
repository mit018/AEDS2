...
class TreeSort {
  ...
  private void sort(No i, Series[] array) {
    if (i != null) {
      sort(i.esq, array);
      array[n++] = i.elemento;
      sort(i.dir, array);
  ...
  public static boolean igual(TreeSort a1, TreeSort a2) {
...
public class TP04Q05 {
  ...
  public static void main(String[] args) {
    ...
    TreeSort arvoreSeries = new TreeSort();
    ...
    Series[] array = arvoreSeries.sort();
    for(int i = 0; i < array.length; i++){
      array[i].imprimir();	
    }

    Arq.openWrite("734661_treesort.txt");
