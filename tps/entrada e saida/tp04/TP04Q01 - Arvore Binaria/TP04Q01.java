...
class ArvoreBinaria {
   ...
   * @throws Exception Se o elemento existir.
   */
  public void inserirPai(Series x) throws Exception {
    if (raiz == null) {
      raiz = new No(x);
   ...
   * @throws Exception Se o elemento existir.
   */
  private void inserirPai(Series x, No i, No pai) throws Exception {
    if (i == null) {
...
public class TP04Q01 {
  ...
  public static void processa(String linha, ArvoreBinaria arvore) {
    ...
    switch (linha.charAt(0)) {
      case 'I':
        serie.ler(split[1]);
        try {
          if (arvore.pesquisar2(serie.getNome()) == false) {
  ...
  public static void main(String[] args) {
    ...
    ArvoreBinaria arvoreSeries = new ArvoreBinaria();
    ...
    Arq.openWrite("734661_arvoreBinaria.txt");
