...
public class ArvoreBinaria {
   ...
   * @param i No em analise.
   */
  private void getNoInfo(No i) {
    if (i != null) {
      System.out.print(
        "[ elemento = " +
        i.elemento +
        ", profundidade = " +
        getProfundidade(i.elemento)
      );
      if (i.esq != null) {
        System.out.print(", filho esq = " + i.esq.elemento);
      } else {
        System.out.print(", filho esq = null");
      }
      if (i.dir != null) {
        System.out.print(", filho dir = " + i.dir.elemento);
      } else {
        System.out.print(", filho dir = null");
      }
      System.out.print(" ]");
      System.out.println("");

      getNoInfo(i.esq); // Elementos da esquerda.
      getNoInfo(i.dir); // Elementos da direita.
    }
  }
   ...
   * @return int menor elemento da árvore
   */
  public int getSegMenor() {
    int resp = -1;

    if (raiz != null) {
      No i;
      int menor = getMenor();
      for (i = raiz; i.esq.elemento != menor; i = i.esq);
      resp = i.elemento;
    }
  ...
  /**
   * Metodo que retorna a altura do nó x
   * @return int altura do nó
   */
  public int getAltura(int x) {
    int resp;
    resp = getAltura(getNo(x), 0);
    return resp;
  }
   ...
   * @param i No em analise.
   */
  private void getFolhasEsq(No i) {
    if (i != null) {
      getFolhasEsq(i.esq); // Elementos da esquerda.
      if (i.esq == null && i.dir == null) {
        System.out.print(i.elemento + " "); // Conteudo do no.
      }
      getFolhasEsq(i.dir); // Elementos da direita.
    }
  }
   ...
   * @param i No em analise.
   */
  private void getFolhasDir(No i) {
    if (i != null) {
      getFolhasDir(i.dir); // Elementos da esquerda.
      if (i.esq == null && i.dir == null) {
        System.out.print(i.elemento + " "); // Conteudo do no.
      }
      getFolhasDir(i.esq); // Elementos da direita.
    }
  }
  ...
  /**
   * Metodo que retorna a profundidade da arvore
   * @return profundidade da arvore
   */
  ...
  /**
   * Metodo que retorna a profundidade do nó
